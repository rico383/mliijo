...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/mlijo.jpg" rel="icon">
...
<!-- ======= Header ======= -->
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Mlijo.com MIF A</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
   ...
   <a href="https://github.com/RicoGanteng-90"></a>
    </div>
  </footer><!-- End Footer -->
